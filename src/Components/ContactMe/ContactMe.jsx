        ...
        <div id="contact">
            ...
            <div className="grid md:grid-cols-12 py-3 md:py-5 gap-5">
                ...
                <div className="order-2 md:order-1 md:col-span-8 space-y-3">
                    ...
                    <div data-aos="zoom-in" className=" p-3 shadow rounded-md shadow-orange-950 bg-orange-100 font-medium">
                ...
                <div className="order-1 md:order-2 md:col-span-4 space-y-3">
                    ...
                    <div data-aos="zoom-in" className=" p-3 lg:p-5 shadow rounded-md font-medium text-sm shadow-orange-950 bg-orange-100">
